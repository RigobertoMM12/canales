...
import { PlazoModelN } from './models/PlazoModelN';
...
export class PlazoComponent implements OnInit {
  ...
  constructor(private plazoService: PlazoService,private productoService:ProductoService,
  ...
  config: any;
   arrPlazo: PlazoModelN[]=[]
  collection = { count: 60, data: this.arrPlazo };
